...
object PromptLibrary {
    ...
    val all: List<PromptTemplate> = listOf(
        // ---------------- Research ----------------
        PromptTemplate(
            "news_today", "Today's briefing", "Research", "📰",
        ...
        PromptTemplate(
            "compare_products", "Compare two products", "Research", "⚖️",
        ...
        PromptTemplate(
            "fact_check", "Fact-check a claim", "Research", "🔍",
        ...
        PromptTemplate(
            "deep_dive", "Deep dive report", "Research", "📚",
        ...
        // ---------------- Files ----------------
        PromptTemplate(
            "budget_csv", "Monthly budget CSV", "Files", "📊",
        ...
        PromptTemplate(
            "summarize_file", "Summarise a document", "Files", "📄",
        ...
        PromptTemplate(
            "convert_file", "Convert & clean data", "Files", "🔄",
        ...
        // ---------------- Coding ----------------
        PromptTemplate(
            "explain_code", "Explain this code", "Coding", "🧩",
        ...
        PromptTemplate(
            "build_script", "Write a script", "Coding", "⚙️",
        ...
        // ---------------- Productivity ----------------
        PromptTemplate(
            "plan_week", "Plan my week", "Productivity", "🗓️",
        ...
        PromptTemplate(
            "email", "Draft a message", "Productivity", "✉️",
        ...
        PromptTemplate(
            "meeting_notes", "Turn notes into actions", "Productivity", "✅",
        ...
        // ---------------- Learning ----------------
        PromptTemplate(
            "explain_simple", "Explain like I'm new", "Learning", "🎓",
        ...
        PromptTemplate(
            "study_plan", "30-day study plan", "Learning", "📆",
        ...
        PromptTemplate(
            "flashcards", "Make flashcards", "Learning", "🃏",
